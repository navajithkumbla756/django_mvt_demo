...
from .permissions import IsAdminRole, IsCandidateRole, IsJobOwner
...
@extend_schema(
    summary="System Admin Metrics",
    responses={200: OpenApiResponse(description="Platform telemetry & user statistics")},
)
